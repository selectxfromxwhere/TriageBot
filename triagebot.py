...
def airway():
    ...
    if airwayStatus.lower() == 'yes': #change input value to lower to avoid bugs, this will be repeated throughout
        unstable()
    else:
...
def circulation():
    ...
    if circulationStatus.lower() == 'yes':
        unstable()
    else:
